...
public class FilesContentInfoViewModel {
	...
	public FilesContentInfoViewModel(int sid, int userId, ArrayList<FileContentInfoViewModel> files) {
		setSid(sid);
		setUserId(userId);
		setFiles(files);
	}
	 ...
	 */
	public void setFiles(ArrayList<FileContentInfoViewModel> files) {
		this.files = files;
	}
}
