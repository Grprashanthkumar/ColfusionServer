...
public abstract class UnitTestBase  {
	...
	public static void afterClass() throws Exception {
		for (final String sysProperty : systemPropertiesToCleanAfterClass) {
	...
	public void afterMethod() throws Exception {
		for (final String sysProperty : this.systemPropertiesToCleanAfterMethod) {
			System.clearProperty(sysProperty);
		};

		this.systemPropertiesToCleanAfterMethod.clear();
	}
	...
	protected void redefineSystemPropertyForMethod(final String propertyName, final String value) {
		...
		this.systemPropertiesToCleanAfterMethod.add(propertyName);
	}
